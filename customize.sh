    ...
    if ! grep -q "vendor/$t" "$WORK_DIR/configs/file_context-vendor"; then
      {
        ...
        echo "/vendor/tee_$t/00000000-0000-0000-0000-53454d655345 u:object_r:tee_file:s0"
    ...
    if ! grep -q "vendor/$t" "$WORK_DIR/configs/fs_config-vendor"; then
      {
        ...
        echo "vendor/tee_$t/00000000-0000-0000-0000-53454d655345 0 0 644 capabilities=0x0"
